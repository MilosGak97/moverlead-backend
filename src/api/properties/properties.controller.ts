...
export class PropertiesController {
  ...
  @Post("export-results-initial")
  async exportResultsInitial(@Body() exportResultsDto: ExportResultsDto) {
    return await this.propertiesService.exportResultsInitial(exportResultsDto);
  }

  @Post("export-results-daily")
  async exportResultsDaily(@Body() exportResultsDto: ExportResultsDto) {
    return await this.propertiesService.exportResultsInitial(exportResultsDto);
  }
